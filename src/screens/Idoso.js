      ...
      >
       ...
       <Section style={{marginBottom:10}}>
          ...
          <Text fontWeight="bold" style={{ textAlign: "center" }}>
            ...
            <Button
            status="warning"
             style={{ textAlign: "center",backgroundColor:"orange",marginTop:10 }}
            text= "RECOMENDADAS EM SITUAÇÕES ESPECIAIS"
            />
            <Text style={{ textAlign: "left",marginTop:10 }}>
            .Hepatite A
            </Text>
            ...
            <Button
              ...
              status="primary"
              onPress={() => Linking.openURL("https://sbim.org.br/images/calendarios/calend-sbim-idoso.pdf")}
            />
